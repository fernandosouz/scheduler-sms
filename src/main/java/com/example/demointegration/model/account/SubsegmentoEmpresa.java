...
public class SubsegmentoEmpresa {
    ...
    public SubsegmentoEmpresa(){};

    public SubsegmentoEmpresa(String id, String logicalName, String name, ArrayList keyAttributes, Number rowVersion) {
        Id = id;
