...
public class GerNacAprovador {
    ...
    public GerNacAprovador(){};

    public GerNacAprovador(String id, String logicalName, String name, ArrayList keyAttributes, Number rowVersion) {
        Id = id;
