...
public class ClienteProvavel {
    ...
    public ClienteProvavel(){};

    public ClienteProvavel(String id, String logicalName, String name, ArrayList keyAttributes, Number rowVersion) {
        Id = id;
